...
from application.database.models import Custom, Floor, UserAbility, UserStatus, UserPreference, Home, Room, Zone, Appliance, Photo, Task, TaskAnnotation, TaskProgress, Supply
...
def reset_user_data():
    try:
        ...
        models_to_delete = [UserAbility, UserStatus, UserPreference, Supply, TaskProgress, TaskAnnotation, Task, Photo, Appliance, Zone, Room, Home, Floor, Custom]
