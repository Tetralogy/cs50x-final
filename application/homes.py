...
@homes.route('/home/name', methods=['POST'])
@login_required
def name_home(): #FIXME: fucking not working
    ...
    if request.method == 'POST':
        if not current_user.active_home_id:
            ...
            return render_template('onboarding/parts/home/attributes/home_name.html.jinja', home_name = new_home.home_name)
        else:
            home_name = request.form.get('home_name')
